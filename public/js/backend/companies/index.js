$(function () {
    ...
    var formatActionField = function (row, cell, formatterParams) {
        return '<form id="form-delete-' + row.getData()['id'] + '" action="' + rootUrl + '/admin/company/delete/" method="get">' +
               '<a class="btn btn-primary" href="' + rootUrl + '/admin/company/edit/' + row.getData()['id'] + '" title="Edit"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;' +
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            ...
            {title: "Email", field: "email", minwidth: 200, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Postcode", field: "postcode", minwidth: 200, headerFilter: "input", headerFilterPlaceholder: " "},
            {title: "Prefecture", field: "display_name", minwidth: 200, headerFilter: "input", headerFilterPlaceholder: " "},
